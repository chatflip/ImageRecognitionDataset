...
if __name__ == '__main__':
    ...
    for num_subset in range(0,10):
        ...
        train_lists = np.genfromtxt(root+"/csv/caltech256_train_subset"+str(num_subset)+".csv",dtype=np.str)
        test_lists = np.genfromtxt(root+"/csv/caltech256_test_subset"+str(num_subset)+".csv",dtype=np.str)
